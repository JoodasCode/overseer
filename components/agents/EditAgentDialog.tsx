      ...
      if (user) {
        await supabase
          ...
          .insert({
            ...
            description: `Updated agent ${data.name}`,
            metadata: { 
              changes: Object.keys(updatedData).filter(key => 
                updatedData[key as keyof typeof updatedData] !== agent[key as keyof Agent]
              )
            },
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update your agent&apos;s personality, tools, and capabilities.
          </DialogDescription>
        </DialogHeader>
